...
@section('content')
    ...
    <!-- Checkout Start -->
    <form action="{{ url('checkout/'.$orderDetailID.'/create-order') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="container-fluid">
            <div class="row px-xl-5">
                <div class="col-lg-8">
                        ...
                        <div class="border-bottom">
                            ...
                            @foreach ($products as $product)
                                <div class="d-flex justify-content-between">
                                    <p>{{ $product['name'] }}</p>
                                    <p>${{ ($product['price'] - $product['price'] * $product['discount']) * $productsMap[$product['id']] }}
                                    </p>
                                </div>
                            @endforeach
                        </div>
