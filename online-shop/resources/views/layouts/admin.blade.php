        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Ohoud Ahmed</a>
                        <a href="#" class="d-block">el3en.12@gmail.com</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/view-users')}}" class="nav-link {{(request()->segment(2) == 'view-users') ? 'active':''}}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Users
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/view-orders')}}" class="nav-link {{(request()->segment(2) == 'view-order' || request()->segment(2) == 'view-orders') ? 'active':''}}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Orders Placed
                                </p>
